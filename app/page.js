...
export default function Homepage() {
  return (
    <>
      <div className='page'>
      <PageHeader line1={header.line1} line2={header.line2} line3={header.line3} />

      <p className="left">
        I am a <a href="#self-taught">self-taught*</a> web developer who has been working professionally in the field since early 2018. The bulk of my work so far has been
        ...
        that citizens use to access local government services. <a href="assets/dkm-resume.pdf" target="_blank">
